...
public class CarItemRowAdapters extends RecyclerView.Adapter<CarItemRowAdapters.ViewHolder> {
    ...
    public CarItemRowAdapters(Context context, ArrayList<ClassCar> items) {
